      ...
      <table className="w-full text-left border-separate border-spacing-0 bg-background3 px-[14px] ">
        <thead>
          <tr className="text-sm text-gray-500 ">
            <th className="py-[14px] border-b border-r border-[rgba(29,30,33,0.1)] text-color1   text-[12px]  font-medium text-left">
              Name
            </th>
            <th className="pl-[10px] py-[14px] border-b border-r border-[rgba(29,30,33,0.1)] text-color1   text-[12px]  font-medium text-left">
              Email
            </th>
            <th className="pl-[10px] py-[14px] border-b border-[rgba(29,30,33,0.1)] text-color1   text-[12px]  font-medium text-left">
              Spent ($)
            </th>
          </tr>
        </thead>
        <tbody>
          {recentCustomers && recentCustomers.map((c) => (
            <tr key={c.id}>
              ...
              <td className="py-2 border-b border-r border-[rgba(29,30,33,0.1)] text-[12px] text-color font-medium ">
                {c.email}
              </td>
